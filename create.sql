...
CREATE TABLE DIMACCOUNT"
   (	"SK_ACCOUNTID" NUMBER NOT NULL ENABLE,
	"ACCOUNTID" NUMBER NOT NULL ENABLE,
	"SK_BROKERID" NUMBER NOT NULL ENABLE,
	"SK_CUSTOMERID" NUMBER NOT NULL ENABLE,
	"STATUS" CHAR(10 BYTE) NOT NULL ENABLE,
	"ACCOUNTDESC" CHAR(50 BYTE),
	"TAXSTATUS" NUMBER(1,0) NOT NULL ENABLE,
	"ISCURRENT" CHAR(1 BYTE) NOT NULL ENABLE,
	"BATCHID" NUMBER(5,0) NOT NULL ENABLE,
